...
<div class="min-h-screen">
    ...
    <a href="{{ route('calculator') }}" 
       class="inline-block px-12 py-6 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-black text-2xl rounded-2xl hover:scale-105 transition shadow-2xl">
        Refaire un calcul
    </a>
</div>
</div>
